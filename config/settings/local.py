...
DEFAULT_REDIRECT_URL = "http://127.0.0.1:5500/test.html"
...
print("WARNING: Using InMemoryChannelLayer for local testing. Not suitable for multi-user or production.")